...
public class AnuncioFrecuente extends Anuncio{ //Utilizamos herencia, con la superclase siendo Anuncio
    ...
    public AnuncioFrecuente(){ //Constructor sin argumentos. Inicialización nula.
        super();
        this.descuentoFrecuente = 0.0;
    }
    
    public AnuncioFrecuente(double new_DescuentoFrecuente, String titulo,String descripcion,String seccion, String clienteID){//Constructor con argumentos
