...
public class AnuncioImagen extends Anuncio{ //Utilizamos herencia, con la superclase siendo Anuncio
    ...
    public AnuncioImagen(){ //Constructor sin argumentos. Inicialización nula.
        super();
        this.milimetros = 0.0;
    }
    
    public AnuncioImagen(double new_Milimetros, String titulo,String descripcion,String seccion, String clienteID){//Constructor con argumentos
