...
public class AnuncioTradicional extends Anuncio { //Utilizamos herencia, con la superclase siendo Anuncio
    ...
    public AnuncioTradicional(){ //Constructor sin argumentos
        super();
        this.descuento = false;
    }
    
    public AnuncioTradicional(String titulo,String descripcion,String seccion,boolean new_Descuento){//Constructor con argumentos
